      ...
      <div className="container contact-wrap">
        <div className="title-box  text-left pt-4" style={{ paddingTop: 30 }}>
          <div className="text-left">
            <p>
              Engage us We’d love to hear from you. Enquiries, feedback or
              simply for a chat. Email to{" "}
              <a href="mailto:x11studiovn@gmail.com">x11studiovn@gmail.com</a>{" "}
              or call us at 0849992882.
            </p>
            <p>
              Visit us at Facebook{" "}
              <a href="https://www.facebook.com/X11DesignStudio/">
                https://www.facebook.com/X11DesignStudio/
              </a>
              , Instagram or Behance to connect with us so that you can be
              updated with our latest news and works.
            </p>
            <p>Join us</p>
